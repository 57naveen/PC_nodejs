   ...
   // .input('token', sql.NVarChar, token)
    ...
    timeout: 120000, // 60 seconds, adjust as needed
        ...
        const mailOptions = {
            ...
            html: `
                <p>Dear ${userName},</p>
                <p>You recently requested to reset your password. To initiate the process, please click on the following link:</p>
                <p><a href="http://localhost:5000/passreset">Click Here To Reset Password</a></p>
                <p>Verification code: ${sixDigitCode}</p>
                <p>If you did not make this request, you can ignore this email; your password will remain unchanged.</p>
                <p>Best regards,<br>Enterprise Software Solutions PVT LTD</p>
            `,
        };
        ...
        transporter.sendMail(mailOptions, (error, info) => {
            if (error) {
                ...
                return res.render('forgotpage', { msg: 'Please check your mail', msg_type:"good" })
    ...
    try {
        ...
        if (updateUserQuery.rowsAffected[0] === 1) {
            ...
            if (deletecodeQuery.rowsAffected[0] === 1) {
                ...
                return res.render('passreset', { msg: 'Password Changed', msg_type: 'good' });
            } else {
