...
// Define a scheduled job to update SignOutTime every day at a specific time (e.g., midnight '0 0 * * *' or '*/5 * * * *' )
const updateSignOutTimeJob = schedule.scheduleJob('0 0 * * *' , async (r) => {
    try {
        var config = {    
            database:'login',
            server:'WIN-MUSC6MOGOU0\\SQLEXPRESS',
            ...
            attachments: [
                {
                    ...
                    contentType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', // Specify the content type for Excel files
                },
            ],
        };
